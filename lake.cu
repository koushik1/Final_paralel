...
void run_cpu_5pt(double *u, double *u0, double *u1, double *pebbles, int n, double h, double end_time);
...
int main(int argc, char *argv[])
{
  ...
  double *u_i0, *u_i1;
  double *u_cpu, *u_cpu_5pt, *u_gpu, *pebs;
  double h;
  ...
  u_cpu_5pt = (double*)malloc(sizeof(double) * narea);
  ...
  run_cpu_5pt(u_cpu_5pt, u_i0, u_i1, pebs, npoints, h, end_time);


  print_heatmap("lake_f.dat", u_cpu, npoints, h);
  print_heatmap("lake_f_5pt.dat", u_cpu_5pt, npoints, h);
